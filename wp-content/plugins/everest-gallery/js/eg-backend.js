(function ($) {
    ...
    $(function () {
        ...
        $('body').on('click', '.eg-settings-item', function () {
			...
			$(this).closest('.eg-each-gallery-item').find('.eg-gallery-item-detail-wrap .eg-gallery-item-detail-fields .eg-field-wrap.url-division').hide();
        });
        ...
        $('.eg-fetch-instagram-trigger').click(function () {
			...
			var user_id =$('#eg-instagram-user-id').val();
...
//                             $('.eg-backend-popup').hide();
//                         }
                        $('.eg-without-filter-gallery-items-wrap').append(response);
						 $('.eg-without-filter-gallery-items-wrap').sortable({
                                handle: ".eg-move-item",
                                containment: "parent"
                            });
		...
		$('.eg-fetch-instagram-trigger-personal').click(function () {
            var $selector = $(this);
            var instagram_username = $('#eg-instagram-username').val();
            var total_number = $('#eg-instagram-total-image').val();
            var access_token = $('#eg-instagram-access-token').val();
            ...
            if (instagram_username == '' || total_number == '' || access_token == '') {
                ...
                var data = {
                    action: 'eg_fetch_instagram_images_personal',
                    _wpnonce: eg_backend_js_object.ajax_nonce,
                    username: instagram_username,
                    total_number: total_number,
                    access_token: access_token,
