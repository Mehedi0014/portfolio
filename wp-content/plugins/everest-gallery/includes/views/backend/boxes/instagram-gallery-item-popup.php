...
<div class="eg-instagram-gallery-item-popup eg-gallery-popup-form" style="display:none;">
    ...
    <div class="eg-popup-inner-wrap">
		...
		<div class="eg-field-wrap">
            <label><?php _e('User Id', 'everest-gallery'); ?></label>
            <div class="eg-field">
                <input type="text" id="eg-instagram-user-id" value="<?php echo isset($eg_settings[ 'instagram_user_id' ]) ? esc_attr($eg_settings[ 'instagram_user_id' ]) : ''; ?>"/>
        ...
        <div class="eg-field-wrap">
            <label></label>
            <div class="eg-field">
                <input type="button" class="eg-button-primary eg-fetch-instagram-trigger" value="<?php _e('Fetch Images for Business Account', 'everest-gallery'); ?>"/>
        ...
        <div class="eg-field-wrap">
            <label></label>
            <div class="eg-field">
                <input type="button" class="eg-button-primary eg-fetch-instagram-trigger-personal" value="<?php _e('Fetch Images for Personal Account', 'everest-gallery'); ?>"/>
                <img src="<?php echo EG_IMG_DIR . 'ajax-loader-add.gif' ?>" class="eg-ajax-loader"/>
                <div class="eg-error eg-instagram-error"></div>
            </div>
        </div>
