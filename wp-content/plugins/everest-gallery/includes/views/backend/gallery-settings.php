<div class="wrap eg-wrap">
    ...
    <div class="eg-content-wrap">
        ...
        <div class="eg-field-wrap">
            <p><?php _e('If your instagram account is business account,', 'everest-gallery'); ?><a target="_self" class="fb_login_btn" href="https://demo.accesspressthemes.com/wordpress-plugins/everest-gallery/graph/index.php?back_url=<?php echo admin_url('admin.php?page=eg-settings'); ?>">Click Here</a><?php _e(' to get instagram user id and access token.', 'everest-gallery'); ?></p>
            <p><?php _e('If your instagram account is personal account,', 'everest-gallery'); ?> <a target="_self" class="fb_login_btn" href="https://demo.accesspressthemes.com/wordpress-plugins/everest-gallery/basic-api/index.php?back_url=<?php echo admin_url('admin.php?page=eg-settings'); ?>">Click Here</a><?php _e(' to get instagram user id and access token.', 'everest-gallery'); ?></p>
        </div>

        <div class="eg-field-wrap">
            <label><?php _e('Instagram User Id', 'everest-gallery'); ?></label>
            <div class="eg-field">
                <input type="text" name="gallery_settings[instagram_user_id]" class="eg-settings-field" value="<?php if(isset($_GET["instaid"])){
                    echo $_GET["instaid"];
                    }elseif(isset($_GET["userid"])){
                        echo $_GET["userid"];
                        }else{
                            if (isset ($gallery_settings[ 'instagram_user_id' ] ) ) {
                                echo esc_attr($gallery_settings[ 'instagram_user_id' ] );
                            }
                        }
                        ?>">
                ...
                <div class="eg-field-wrap">
                    ...
                    <div class="eg-field">
                        <input type="text" name="gallery_settings[instagram_access_token]" class="eg-settings-field" value="<?php if(isset($_GET["access_token"])){ echo $_GET["access_token"]; }else{
                            if (isset ($gallery_settings[ 'instagram_access_token' ] ) ) {
                                echo esc_attr($gallery_settings[ 'instagram_access_token' ] );
                            }}?>">
                            <?php $access_token_link = 'https://api.instagram.com/oauth/authorize/?client_id=54da896cf80343ecb0e356ac5479d9ec&scope=basic+public_content&redirect_uri=http://api.web-dorado.com/instagram/?return_url=' . site_url('/?eg_instagram_callback=true') . '&response_type=token'; ?>
