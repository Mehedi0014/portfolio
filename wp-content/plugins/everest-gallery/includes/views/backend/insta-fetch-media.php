...
//                         return $user -> id;
    ...
    function userMedia(){
        ...
        $url='https://graph.facebook.com/v10.0/'. $this -> user_id.'/media?fields=username,id,media_type,caption,permalink,thumbnail_url,media_url,like_count,profile_picture_url,children{media_url,id,media_type,timestamp,permalink,thumbnail_url},comments_count,owner,timestamp&limit='.$total_number.'&access_token='. $this -> access_token;
