...
if ( !class_exists('EG_Admin_Ajax') ) {
    ...
    class EG_Admin_Ajax extends EG_Library {
        ...
        function __construct() {
			...
			add_action('wp_ajax_eg_fetch_instagram_images_personal', array( $this, 'get_instagram_images_personal' ));
            add_action('wp_ajax_nopriv_eg_fetch_instagram_images_personal', array( $this, 'no_permission' ));
            /**
		...
		function get_instagram_images_personal() {
            if ( isset($_POST[ '_wpnonce' ]) && wp_verify_nonce($_POST[ '_wpnonce' ], 'eg_ajax_nonce') ) {
                // die('fgd');
                include(EG_PATH . '/includes/views/backend/ajax/instagram-gallery-personal-html.php');
                die();
            } else {
                die('No script kiddies please!!');
            }
